package net.eskimo.voiditemod.entity.custom;
...
public class VKProjectileEntity extends AbstractArrow {
    private float rotation;
    public Vec2 groundedOffset;

    public VKProjectileEntity(EntityType<? extends AbstractArrow> entityType, Level level) {
        super(entityType, level);
    }

    public VKProjectileEntity(LivingEntity shooter, Level level) {
        super(ModEntities.VK.get(), shooter, level, new ItemStack(ModItems.VK.get()), null);
    }

    @Override
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItems.VK.get());
    }
